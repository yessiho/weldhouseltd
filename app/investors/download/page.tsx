        ...
        <div className="container">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "1.5rem", marginBottom: "4rem" }}>
              ...
              <div style={{ padding: "2rem" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1.5rem" }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontFamily: "var(--font-condensed)", fontSize: "0.65rem", color: "var(--text-muted)", letterSpacing: "0.12em", textTransform: "uppercase" }}>PDF · Project Overview</div>
                  </div>
                </div>

                <p style={{ fontSize: "0.87rem", color: "var(--text-muted)", lineHeight: 1.7, marginBottom: "1.5rem" }}>
                  The Executive Summary covering the project overview, team profiles, location details, SWOT analysis and risk mitigation strategies.
                </p>

                <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "0.5rem", marginBottom: "2rem" }}>
                  {[
                    "Project scope and schedule breakdown",
                    "Team profiles and qualifications",
                    "Land title and survey documentation",
                    "SWOT and risk mitigation tables",
                    "Yard design and QA approach",
            ...
            <div style={{ background: "var(--bg-card)", border: "1px solid var(--border-green)", borderTop: "3px solid var(--green)", borderRadius: "3px", overflow: "hidden" }}>
              <div style={{ padding: "2rem" }}>
                ...
                <p style={{ fontSize: "0.87rem", color: "var(--text-muted)", lineHeight: 1.7, marginBottom: "1.5rem" }}>
                  The complete investor documentation package including the independent Business Plan, Financial Model, land title documents, survey plans and government correspondence.
                </p>

                <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "0.5rem", marginBottom: "2rem" }}>
                  {[
                    "Independent Business Plan & Financial Model",
              ...
              <div style={{ padding: "1rem 2rem", background: "rgba(74,124,47,0.05)", borderTop: "1px solid var(--border-green)" }}>
                <div style={{ display: "flex", gap: "0.5rem", alignItems: "center" }}>
                  <Shield size={13} color="var(--green-light)" />
                  <span style={{ fontFamily: "var(--font-condensed)", fontSize: "0.65rem", color: "var(--text-muted)", letterSpacing: "0.1em" }}>Hold Harmless Agreement required for financial documents</span>
                </div>
              </div>
            </div>
              ...
              <div style={{ padding: "2rem" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1.5rem" }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontFamily: "var(--font-condensed)", fontSize: "0.65rem", color: "rgba(255,255,255,0.5)", letterSpacing: "0.12em", textTransform: "uppercase" }}>Investor Relations Team</div>
                  </div>
                </div>

                <p style={{ fontSize: "0.87rem", color: "rgba(255,255,255,0.7)", lineHeight: 1.7, marginBottom: "1.5rem" }}>
                  Speak directly with our investor relations team to discuss the opportunity, ask questions about the project and explore how you can participate.
                </p>
          ...
          <div style={{ maxWidth: "800px", margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "1rem" }}>
              {[
                { step: "01", title: "Executive Summary",  desc: "Start with the executive summary for a full project overview.",                         href: "/investors/download", action: "Download PDF" },
                { step: "02", title: "Financial Details",  desc: "Financial model available under Hold Harmless Agreement — request via email.",           href: "/financials",          action: "Request Access" },
                { step: "03", title: "Project Scope",      desc: "Understand the 40-month build programme and schedule breakdown.",                        href: "/project/scope",       action: "View Scope" },
            ...
            <div style={{ display: "flex", gap: "0.75rem", alignItems: "flex-start" }}>
              ...
              <div>
                ...
                <p style={{ fontSize: "0.85rem", color: "var(--text-muted)", margin: 0, lineHeight: 1.7 }}>
                  All documents provided by WeldHouse Limited are strictly confidential and are intended solely for the use of the individual or entity to whom they are addressed. Financial documentation is only released upon execution of a Hold Harmless Agreement. Recipients are not authorised to reproduce or distribute any information without the prior written consent of WeldHouse Limited.
                </p>
              </div>
            </div>
          </div>
