...
export default function KeyStats() {
  const stats = [
    ...
    { value: "20+",    label: "Contracts On Standby",   description: "Offshore fabrication contracts are waiting — financial details shared privately with investors.", icon: "📋" },
    { value: "95",     label: "Oil Blocks Undeveloped", description: "95 offshore oil blocks in Nigeria are yet to be developed — all requiring in-country fabrication.", icon: "🛢️" },
    ...
    { value: "1,500+", label: "African Oilfields",      description: "Deep-water oilfields available across Nigeria and other African countries ready for development.", icon: "🌍" },
  ];
      ...
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: "4rem" }}>
          ...
          <p style={{ maxWidth: "520px", margin: "1rem auto 0", fontSize: "0.95rem" }}>
            The WeldHouse Fabrication Yard will establish Nigeria&apos;s first modern large-scale Oil &amp; Gas Fabrication Yard — enabling full in-country compliance with the Nigerian Content Law.
          </p>
        </div>
