// components/investors/DeloitteEndorsement.tsx

import { TrendingUp } from "lucide-react";

export default function DeloitteEndorsement() {
  return (
    <div style={{ background: "var(--bg-card)", border: "1px solid var(--border-green)", borderTop: "3px solid var(--orange)", padding: "2.5rem", borderRadius: "3px", textAlign: "center" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "1rem", marginBottom: "1.5rem" }}>
        ...
        <div style={{ textAlign: "left" }}>
          <div style={{ fontFamily: "var(--font-display)", fontSize: "1.4rem", color: "var(--text-primary)", letterSpacing: "0.03em" }}>Deloitte &amp; Touche</div>
          <div style={{ fontFamily: "var(--font-condensed)", fontSize: "0.68rem", color: "var(--text-muted)", letterSpacing: "0.12em", textTransform: "uppercase" }}>Independent Financial Model</div>
        </div>
      </div>

      <p style={{ fontSize: "0.9rem", color: "var(--text-secondary)", lineHeight: 1.8, maxWidth: "500px", margin: "0 auto 2rem" }}>
        Deloitte independently developed the Business Plan and Financial Model for this venture — confirming the project as highly profitable and commercially feasible.
      </p>
